...
<body class="min-h-screen bg-[#333333] flex flex-col">

  <main class="flex flex-1 items-center justify-center">
    <div class="bg-[#777777] p-8 rounded-xl shadow-lg border border-white w-96 text-center">

      <h1 class="text-3xl font-bold mb-2 text-white">Welcome!</h1>
      <p class="text-white mb-6">Log in to your account</p>
...
<form action="php/login.php" method="POST" class="flex flex-col space-y-4 mb-6">
        ...
        <input type="text" name="email" placeholder="BU Email or admin" 
               ...
               class="px-3 py-2 bg-transparent text-white border border-white rounded-lg focus:outline-none focus:ring-2 focus:ring-white">
...
<div class="relative w-full">
  <input
    ...
    class="w-full px-3 py-2 pr-10 bg-transparent text-white border border-white rounded-lg focus:outline-none focus:ring-2 focus:ring-white"
    required
  >
  <span
  ...
  >
    👁️
        ...
        <!-- Login button -->
        <button type="submit" class="w-full px-6 py-2 bg-green-500 text-white rounded-lg hover:bg-green-600">
          Log in
        </button>
