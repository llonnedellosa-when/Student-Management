...
<body class="min-h-screen bg-sky-100 flex flex-col">

    <header class="bg-gradient-to-t from-sky-300 to-orange-300 border-white h-36 shadow-md">
        <nav class="max-w-2x1 mx-auto px-2 py-4 flex justify-between items-center text-white">
            <div class="flex items-center space-x-3">
                ...
                <h1 class="text-4xl font-bold py-10">BICOL UNIVERSITY POLANGUI CLINIC</h1>
            </div>
        </nav>
    </header>
    ...
    <div class="group fixed top-[140px] left-0 h-[calc(100vh-140px)] 
        ...
        <!-- Home -->
        <a href="Home.php"
            class="flex items-center gap-4 px-4 py-3 text-black hover:text-gray hover:bg-blue-500 transition">
